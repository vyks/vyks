...
Main.Active = true
PlrName.Text = "Vykzs?"
PlrVH.Text = "VYKZS REMAKE"
PlrVH.TextSize = 10
PlrIcon.Image = "https://www.roblox.com/headshot-thumbnail/image?userId=488098700&width=420&height=420&format=png"
...
Input.FocusLost:connect(function(Enter)
	if Enter then
		...
		Header = "             hello fellow hot meisters              \n\n              tis i vykzs              \n\n              join .gg/scripting! :D              \n\n\n\n\n\n\n\n"
